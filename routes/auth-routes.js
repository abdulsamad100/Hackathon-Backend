...
router.post("/register", async (req, res) => {
    ...
    const Schema = Joi.object({
        email: Joi.string().email().required(),
        cnic: Joi.string().length(13).regex(/^\d+$/).required(), // CNIC must be exactly 13 numeric characters
    ...
    try {
        ...
        const newUser = new UserModel({ name, email, cnic, password: hashedPassword });
        await newUser.save();
        ...
        const transporter = nodemailer.createTransport({
            service: "gmail",
            auth: {
                user: "samadjs100@gmail.com", // Your email address
